...
function OpenCloakroomMenu()
	...
	if grade == 'recruit' then
		table.insert(elements, {label = _U('sheriff_wear'), value = 'recruit_wear'})
	elseif grade == 'officer' or grade == 'sous-officier' or grade == 'Off-stup' then
		table.insert(elements, {label = _U('sheriff_wear'), value = 'officer_wear'})
	elseif grade == 'sergeant' or grade == 'sergent-stup' then
		table.insert(elements, {label = _U('sheriff_wear'), value = 'sergeant_wear'})
	elseif grade == 'lieutenant' then
		table.insert(elements, {label = _U('sheriff_wear'), value = 'lieutenant_wear'})
	elseif grade == 'boss' then
		table.insert(elements, {label = _U('sheriff_wear'), value = 'boss_wear'})
	end
