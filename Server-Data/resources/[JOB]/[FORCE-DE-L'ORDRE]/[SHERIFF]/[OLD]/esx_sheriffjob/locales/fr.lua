Locales['fr'] = {
  ...
  ['police_wear'] = 'tenue Sheriff',
  ['gilet_wear'] = 'gilet orange',
  ['bullet_wear'] = 'gilet pare-balles',
  ['civil_wear'] = 'Badges Agent Civil',
  ...
  ['handcuff2'] = 'Vous avez été menotté Menotté / Démenotté',
  ['drag'] = 'escorter',
  ['put_in_vehicle'] = 'mettre dans véhicule',
  ['out_the_vehicle'] = 'sortir du véhicule',
  ['fine'] = 'Amende',
  ['fine2'] = 'Amende (Choix du montant)',
  ...
  ['police_stock'] = 'coffre des sheriff',
  -- Misc
