...
function OpenCloakroomMenu()
	...
	local elements = {
		...
		{ label = 'Tenue Moto', value = 'tenu_stage' },
		{ label = 'Tenue Officier', value = 'tenu_mary' },
		{ label = 'Tenue Sherrif', value = 'tenu_heli' },
		{ label = 'Tenue De Cérémonie', value = 'tenu_fib' },
		{ label = 'Tenue Opération ', value = 'tenu_swatgr'},
		{ label = 'Gillet par Balle', value = 'bullet_wear' },
	}

	--[[if grade == 'recruit' then
		table.insert(elements, {label = _U('Tenue Recrue'), value = 'tenu_recrue'})
		table.insert(elements, {label = _U('Tenue De Cérémonie'), value = 'tenu_ceremonie'})
	elseif grade == 'officer' then
		table.insert(elements, {label = _U('Tenue Moto'), value = 'tenu_stage'})
		table.insert(elements, {label = _U('Tenue De Cérémonie'), value = 'tenu_ceremonie'})
		table.insert(elements, {label = _U('Tenue Opération'), value = 'tenu_swatgr'})
		table.insert(elements, {label = _U('Tenue Officier'), value = 'tenu_officier'})
	...
	elseif grade == 'lieutenant' then
		...
		table.insert(elements, {label = _U('Tenue De Cérémonie'), value = 'tenu_ceremonie'})
		table.insert(elements, {label = _U('Tenue Opération'), value = 'tenu_swatgr'})
		table.insert(elements, {label = _U('Tenue Sherrif'), value = 'tenu_commandant'})
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'cloakroom', {
		...
		data.current.value == 'tenu_fib' or
...
function OpenVehicleSpawnerMenu(type, station, part, partNum)
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle', {
		...
		elseif data.current.action == 'garage' then
			...
			ESX.TriggerServerCallback('redside_vehicleshop:retrieveJobVehicles', function(jobVehicles)
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_shop', {
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_shop_confirm', {
			...
			if data2.current.value == 'yes' then
				local newPlate = "BCSO"..math.random(0000,9999)
										...
										if amount == nil then
											...
											local closestPlayer, closestDistance = ESX.Game.GetClosestPlayer()
												if closestPlayer == -1 or closestDistance > 3.0 then
													...
													TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(closestPlayer), 'society_gouvernor', _U('police'), amount)
												end
										end
								end,
							function(data, menu)
