...
Config.PoliceVehicles = {
		...
		{ model = 'pd9', label = '[CDT] Caprice'},
		{ model = 'pd4', label = '[CDT] Ford inter'},
		{ model = 'pd2', label = '[OFF] Charger'},
		{ model = 'pd5', label = '[OFF] Ford One'},
		{ model = 'pd11', label = '[OFF] Victoria FIB'},
		{ model = 'pd8', label = '[OFF] Chevrolet Noose'},
		{ model = 'code3camero', label = '[CDT] Camero'},
		{ model = 'code3cvpi', label = '[CDT] CVPI '},
		{ model = 'code3gator', label = '[OFF] GATOR'},
		{ model = 'code3mustang', label = '[OFF] MUSTANG'},
		{ model = 'code316fpiu', label = '[OFF] FPIU'},
		{ model = '', label = '-----Motos-----'},		
		{ model = 'code3bmw', label = '[HP] Moto bmw '},		
		{ model = 'code3harley', label = '[HP] Moto Harley '},		
		{ model = '', label = '-----Planque-----'},
		{ model = 'policefelon', label = '[BANA] Felon'},		
		{ model = '', label = '-----Utilitaires-----'},	
		{ model = 'riot', label = '[CPT] Fourgon Blindé'},
		{ model = 'bearcat', label = '[CPT] Insurgent FIB'},
		{ model = 'riot2', label = '[CPT] Fourgon antiémeute'}		
}
