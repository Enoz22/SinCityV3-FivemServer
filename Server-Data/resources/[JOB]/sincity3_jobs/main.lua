...
if Config.MaxInService ~= -1 then
	TriggerEvent('esx_service:activateService', 'fueler2', 20)
end
...
for k,v in pairs(Config.Jobs) do
	if Config.MaxInService ~= -1 then
		TriggerEvent('esx_service:activateService', k..'private', 20)
	end

	TriggerEvent('esx_phone:registerNumber', k..'private', v.PrivateName, true, true)
	TriggerEvent('esx_society:registerSociety', k..'private', k..'private', 'society_'..k..'private', 'society_'..k..'private', 'society_'..k..'private', {type = 'private'})
end

local function Work(source, item)
  Citizen.CreateThread(function()
		TaskStartScenarioInPlace(-1, "PROP_HUMAN_BUM_BIN", 0, true)
		exports['progressBars']:startUI(item[1].time - 200, "Travail")
		Citizen.Wait(item[1].time - 200)
