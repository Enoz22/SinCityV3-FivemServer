Skybar = {
	...
	Zones = {
		...
		Eaudevie = {
			...
			Hint = "Appuyez sur ~INPUT_CONTEXT~ pour récolter des ananas"
		},
		...
		Distillation = {
			...
			Item = {
				{
					name = "Caisse d'eau de vie ananas",
					db_name = 'caiseauvieananas',
					time = 5000,
					max = 20,
					add = 1,
					remove = 8,
					requires = "ananas",
					requires_name = 'ananas',
					drop = 10000,
					remove2 = 1,
			...
			Hint = "Appuyez sur ~INPUT_CONTEXT~ pour Distiller de l'eau de vie d'ananas"
		},
		
		Venteseaudevieananas = {
			...
			Blip = true,
			Interim = false,
			Name = "Dépot d'eau de vie ananas",
			Type = 'delivery',
			Spawner = 1,
			Item = {
				{
					...
					price = 200,
					requires = 'caiseauvieananas',
					requires_name = "caiseauvieananas",
					drop = 10000,
				}
			},
			Hint = "Appuyez sur ~INPUT_CONTEXT~ pour vendre vos caisses d'eau de vie ananas"
		},
	},
