Galaxy = {
	...
	Zones = {
		...
		NoAlcool = {
			Pos   = {  x = 370.6,  y = 288.2,  z = 90.30 },
			Size  = { x = 1.0, y = 1.0, z = 0.20 },
		...
		Tequila = {
			...
			Hint = "Appuyez sur ~INPUT_CONTEXT~ pour récolter de l'agave"
		},
		...
		Distillation = {
			...
			Hint = "Appuyez sur ~INPUT_CONTEXT~ pour Distiller de la téquila"
		},
			...
			Item = {
				{
					...
					price = 200,
					requires = 'Caisse de tequila',
					requires_name = "caistequila",
					drop = 10000
				}
			},
			Hint = "Appuyez sur ~INPUT_CONTEXT~ pour vendre vos caisses de téquila"
		},
	},
