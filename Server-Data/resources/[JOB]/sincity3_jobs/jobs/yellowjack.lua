yellowjack = {
	...
	Zones = {
		...
		Frigo = {
			Pos   = { x = 1993.52,  y = 3045.48,  z = 49.70 },
...
--[[
        Mixologie = {
			Pos   = {  x = 1983.52,  y = 3045.48,  z = 49.70 },
			Size  = { x = 1.0, y = 1.0, z = 0.2 },
			Color = { r = 255, g = 255, b = 255 },
			Marker  = 23,
			Blip = false,
		...
		NoAlcool = {
			Pos   = { x = 2003.52,  y = 3045.48,  z = 49.70 },
			Size  = { x = x = 1.0, y = 1.0, z = 0.2 },
		...
		VehicleSpawner = {
			Pos = {x = 2001.56,  y = 3036.28,  z = 46.30},
			Size = {x = 1.0, y = 1.0, z = 0.2},
			Color = {r = 255, g = 255, b = 255},
			Marker = 23,
			Blip = false,
		...
		VehicleSpawnPoint = {
			Pos = {x = 1995.64,  y = 3029.8,  z = 46.30},
			Size = {x = 1.0, y = 1.0, z = 0.2},
			Marker = -1,
			Blip = false,
			Interim = false,
		...
		VehicleDeletePoint = {
			Pos = { x = 1994.96,  y = 3036.08,  z = 46.20},
...
--]]
		biere = {
			...
			Hint = "Appuyez sur ~INPUT_CONTEXT~ pour récolter du houblon"
		},
		...
		Distillation = {
			...
			Hint = "Appuyez sur ~INPUT_CONTEXT~ pour Distiller de la bière"
		},
			...
			Item = {
				{
					...
					price = 200,
					requires = 'Caisse de bière',
					requires_name = "caisebiere",
					drop = 10000
				}
			},
			Hint = "Appuyez sur ~INPUT_CONTEXT~ pour vendre vos caisses de bières"
		},
	},
