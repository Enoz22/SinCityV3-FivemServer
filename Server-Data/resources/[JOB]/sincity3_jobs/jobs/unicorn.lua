Unicorn = {
	...
	Zones = {
		...
		Canneasucre = {
			...
			Hint = "Appuyez sur ~INPUT_CONTEXT~ pour récolter de la canne à sucre"
		},
		...
		Distillation = {
			...
			Item = {
				{
					...
					add = 1,
					remove = 8,
					requires = "canneasucre",
					requires_name = 'canneasucre',
					drop = 10000,
					remove2 = 1,
			...
			Hint = "Appuyez sur ~INPUT_CONTEXT~ pour faire du rhum"
		},
			...
			Item = {
				{
					...
					price = 200,
					requires = 'Caisse de rhum',
					requires_name = "caisrhum",
					drop = 10000
				}
			},
			Hint = "Appuyez sur ~INPUT_CONTEXT~ pour vendre vos caisses de rhum"
		},
	},
