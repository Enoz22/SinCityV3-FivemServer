Split = {
	...
	Zones = {
		...
		Gin = {
			...
			Hint = "Appuyez sur ~INPUT_CONTEXT~ pour récolter des céréales"
		},
		...
		Distillation = {
			...
			Hint = "Appuyez sur ~INPUT_CONTEXT~ pour Distiller de gin"
		},
			...
			Item = {
				{
					...
					price = 200,
					requires = 'Caisse de gin',
					requires_name = "caisegin",
					drop = 10000
				}
			},
			Hint = "Appuyez sur ~INPUT_CONTEXT~ pour vendre vos caisses de gin"
		},
	},
