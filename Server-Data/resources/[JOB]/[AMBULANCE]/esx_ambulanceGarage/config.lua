...
Config.ambulanceHelicopters = {
	{ model = 'polmav', label = 'ambulance Maverick', livery = 0, price = 0 }
}
...
Config.CarOutFromPolGar = "You took out a ~b~Vehicle~s~ from ~y~ambulance Garage~s~!"
