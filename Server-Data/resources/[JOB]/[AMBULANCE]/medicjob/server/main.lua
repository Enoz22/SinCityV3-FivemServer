		...
		if societyAccount ~= nil then
			...
			for i=1, #xPlayers, 1 do
				if xPlayer.source ~= target then
					...
					print(Config.ReviveReward..' ajouté')
				else
					TriggerClientEvent('esx:showNotification', xPlayer.source,"Vous ne pouvez pas vous auto réanimer")	
				end
			end
		end
		for i=1, #xPlayers, 1 do
...
AddEventHandler('AnnounceEMSOuvert', function()
	...
	for i=1, #xPlayers, 1 do
		local xPlayer = ESX.GetPlayerFromId(xPlayers[i])
		TriggerClientEvent('esx:showAdvancedNotification', xPlayers[i], 'EMS', '~b~Annonce EMS', 'Un EMS est ~g~en service ! ~s~Votre santé avant tout !', 'CHAR_CALL911', 8)
	end
end)
...
AddEventHandler('AnnounceEMSFerme', function()
	...
	for i=1, #xPlayers, 1 do
		local xPlayer = ESX.GetPlayerFromId(xPlayers[i])
		TriggerClientEvent('esx:showAdvancedNotification', xPlayers[i], 'EMS', '~b~Annonce EMS', 'Il n\'y a ~r~plus d\'EMS en service !', 'CHAR_CALL911', 8)
	end
end)
