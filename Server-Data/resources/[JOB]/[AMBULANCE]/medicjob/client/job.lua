...
AddEventHandler('esx_ambulancejob:hasEnteredMarker', function(hospital, part, partNum)
	if ESX.PlayerData.job and ESX.PlayerData.job.name == 'ambulance' then
		...
		elseif part == 'Cloakroom' then
			CurrentAction = part
			CurrentActionMsg = 'Ouvrir le vestiaire'
			CurrentActionData = {}
...
function OpenCloakroomMenu()
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'cloakroom', {
		...
		elements = {
			...
			{label = "Tenue Ambulancier", value = 'tenu_ambulancier'},
			{label = "Tenue Médecin", value = 'tenu_medecin'},
			{label = "Tenue Chirurgien", value = 'tenu_chirurgien'},
			{label = "Tenue Directeur", value = 'tenu_directeur'},
		}
	}, function(data, menu)
		...
		if
			data.current.value == 'tenu_ambulancier' or
			data.current.value == 'tenu_urgentiste' or
			data.current.value == 'tenu_medecin' or
			data.current.value == 'tenu_chirurgien' or
			data.current.value == 'tenu_directeur'
			then
...
function OpenVehicleSpawnerMenu(hospital, partNum)
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle', {
		...
		elseif data.current.action == 'garage' then
			...
			ESX.TriggerServerCallback('vehicleshop:retrieveJobVehicles', function(jobVehicles)
						...
						if data2.current.stored then
							...
							if foundSpawn then
								...
								ESX.Game.SpawnVehicle(data2.current.model, spawnPoint.coords, spawnPoint.heading, function(vehicle)
									...
									TriggerServerEvent('vehicleshop:setJobVehicleState', data2.current.vehicleProps.plate, false)
