...
RageUI.Settings = {
    ...
    Panels = {
        Grid = {
            Background = { Dictionary = "commonmenu", Texture = "gradient_bgd", Y = 4, Width = 431, Height = 255 },
        ...
        if Enabled == true then
            ...
            if RageUI.CurrentMenu ~= nil then
                if RageUI.CurrentMenu() then
                    ...
                    RenderText(RageUI.CurrentMenu.Title, RageUI.CurrentMenu.X + RageUI.Settings.Items.Title.Text.X + (RageUI.CurrentMenu.WidthOffset / 2), RageUI.CurrentMenu.Y + RageUI.Settings.Items.Title.Text.Y, 6, RageUI.Settings.Items.Title.Text.Scale, 255, 255, 255, 255, 1)
