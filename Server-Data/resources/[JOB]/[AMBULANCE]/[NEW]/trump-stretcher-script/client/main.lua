...
local lit = {
	...
	{lit = "stretcher",         	distance_stop = 2.4, title = Config.Language.lit_1},
	{lit = "stryker_M1",         	distance_stop = 2.4, title = Config.Language.lit_1},
	{lit = "stryker_M1_coroner", 	distance_stop = 2.4, title = Config.Language.lit_1},
	{lit = "mxpro",              	distance_stop = 2.4, title = Config.Language.lit_1},
	{lit = "stretcher_basket",   	distance_stop = 2.4, title = Config.Language.lit_1}
}
}
