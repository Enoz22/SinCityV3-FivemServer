...
Config.Language = {
    ...
    open_menu = 'Pressez ~b~E',
    do_action = 'Pressez ~INPUT_CONTEXT~ pour utiliser la civière',
    take_bed = "Pressez ~INPUT_CONTEXT~ pour prendre la civière",
    release_bed = "Pressez ~INPUT_SPECIAL_ABILITY_SECONDARY~ pour lâcher la civière",
    in_vehicle_bed = "Pressez ~INPUT_CONTEXT~ pour ranger la civière",
    out_vehicle_bed = "Pressez ~INPUT_CONTEXT~ pour sortir la civière",
    go_out_bed = "Get Out of Bed",
    delete_bed = "Enlever le lit",
    fold_bed = "Plier le lit",
    toggle_iv = "Basculer le poteau",
    toggle_lp15 = "Basculer Défibrilateur",
    toggle_lucas = "Basculer Masseur",
    toggle_backboard = "Basculer Brancard",
    toggle_scoop = "Basculer Minerve",
    toggle_seat = "Basculer oreiller",
    lit_1 = "Lit sans matelas",
    anim = {
        spawn_command = "Litter",
        lie_back = "Couché sur le dos",
        sit_up = "Se relever",
        sit_right = "Assis sur le côté droit",
        sit_left = "Assis sur le côté gauche",
        convulse = "Recevoir Massage Cardiaque",
        death = "Rester Immobile",
        pls = "Rester en PLS",
    }
}
