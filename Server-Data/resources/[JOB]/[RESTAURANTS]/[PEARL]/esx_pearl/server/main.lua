...
if Config.MaxInService ~= -1 then
  TriggerEvent('esx_service:activateService', 'pearl', Config.MaxInService)
end

TriggerEvent('esx_phone:registerNumber', 'pearl', _U('pearl_customer'), true, true)
TriggerEvent('esx_society:registerSociety', 'pearl', 'Pearl', 'society_pearl', 'society_pearl', 'society_pearl', {type = 'private'})



RegisterServerEvent('esx_pearljob:getStockItem')
AddEventHandler('esx_pearljob:getStockItem', function(itemName, count)

  local _source = source
  local xPlayer = ESX.GetPlayerFromId(_source)

  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_pearl', function(inventory)
...
ESX.RegisterServerCallback('esx_pearljob:getStockItems', function(source, cb)
...
RegisterServerEvent('esx_pearljob:putStockItems')
AddEventHandler('esx_pearljob:putStockItems', function(itemName, count)
...
RegisterServerEvent('esx_pearljob:getFridgeStockItem')
AddEventHandler('esx_pearljob:getFridgeStockItem', function(itemName, count)

  local _source = source
  local xPlayer = ESX.GetPlayerFromId(_source)

  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_pearl_fridge', function(inventory)
...
ESX.RegisterServerCallback('esx_pearljob:getFridgeStockItems', function(source, cb)
...
RegisterServerEvent('esx_pearljob:putFridgeStockItems')
AddEventHandler('esx_pearljob:putFridgeStockItems', function(itemName, count)
...
RegisterServerEvent('esx_pearljob:buyItem')
AddEventHandler('esx_pearljob:buyItem', function(itemName, price, itemLabel)
    ...
    TriggerEvent('esx_addonaccount:getSharedAccount', 'society_pearl', function(account)
...
RegisterServerEvent('esx_pearljob:craftingCoktails')
AddEventHandler('esx_pearljob:craftingCoktails', function(itemValue)
        ...
        SetTimeout(10000, function()        
            ...
            elseif daletQuantity < 1 then
                ...
                if chanceToMiss <= Config.MissCraft then
                    ...
                    TriggerClientEvent('esx:showNotification', _source, _U('craft') .. _U('pearl') .. ' ~w~!')
                    xPlayer.removeInventoryItem('rhum', 2)
                    xPlayer.removeInventoryItem('limonade', 2)
                    xPlayer.removeInventoryItem('menthe', 2)
                    xPlayer.removeInventoryItem('ice', 1)
...
ESX.RegisterServerCallback('esx_pearljob:getVaultWeapons', function(source, cb)

  TriggerEvent('esx_datastore:getSharedDataStore', 'society_pearl', function(store)
...
ESX.RegisterServerCallback('esx_pearljob:addVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_pearljob:removeVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_pearljob:getPlayerInventory', function(source, cb)
