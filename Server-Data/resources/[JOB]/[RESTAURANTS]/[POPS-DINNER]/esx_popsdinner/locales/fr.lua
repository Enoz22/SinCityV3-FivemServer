Locales['fr'] = {
    ...
    ['popsdinner_fridge_stock']   = 'Frigo du Pops Dinner',
    ['fridge_inventory']         = 'Contenu du frigo',

    -- Shops  
    ['shop']                     = 'Boutique du popsdinner',
    ...
    ['popsdinner_stock']            = 'Stock du Pops Dinner',



    ['Acheter_noalcool']                  = 'Acheter boissons',
    ['Acheter_alcool']                    = 'Acheter alcool',
    ['Acheter_apero']                     = 'Acheter apero',
    ...
    -- Misc  
    ['map_blip']                 = 'Pops Dinner',
    ['popsdinner']                = 'Pops Dinner',

    -- Phone  
    ['popsdinner_phone']          = 'Pops Dinner',
    ['popsdinner_customer']       = 'Citoyen'
