...
if Config.MaxInService ~= -1 then
  TriggerEvent('esx_service:activateService', 'popsdinner', Config.MaxInService)
end

TriggerEvent('esx_phone:registerNumber', 'popsdinner', _U('popsdinner_customer'), true, true)
TriggerEvent('esx_society:registerSociety', 'popsdinner', 'popsdinner', 'society_popsdinner', 'society_popsdinner', 'society_popsdinner', {type = 'private'})



RegisterServerEvent('esx_popsdinnerjob:getStockItem')
AddEventHandler('esx_popsdinnerjob:getStockItem', function(itemName, count)

  local _source = source
  local xPlayer = ESX.GetPlayerFromId(_source)

  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_popsdinner', function(inventory)
...
ESX.RegisterServerCallback('esx_popsdinnerjob:getStockItems', function(source, cb)
...
RegisterServerEvent('esx_popsdinnerjob:putStockItems')
AddEventHandler('esx_popsdinnerjob:putStockItems', function(itemName, count)
...
RegisterServerEvent('esx_popsdinnerjob:getFridgeStockItem')
AddEventHandler('esx_popsdinnerjob:getFridgeStockItem', function(itemName, count)

  local _source = source
  local xPlayer = ESX.GetPlayerFromId(_source)

  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_popsdinner_fridge', function(inventory)
...
ESX.RegisterServerCallback('esx_popsdinnerjob:getFridgeStockItems', function(source, cb)
...
RegisterServerEvent('esx_popsdinnerjob:putFridgeStockItems')
AddEventHandler('esx_popsdinnerjob:putFridgeStockItems', function(itemName, count)
...
RegisterServerEvent('esx_popsdinnerjob:buyItem')
AddEventHandler('esx_popsdinnerjob:buyItem', function(itemName, price, itemLabel)
    ...
    TriggerEvent('esx_addonaccount:getSharedAccount', 'society_popsdinner', function(account)
...
RegisterServerEvent('esx_popsdinnerjob:craftingCoktails')
AddEventHandler('esx_popsdinnerjob:craftingCoktails', function(itemValue)
        ...
        SetTimeout(10000, function()        
            ...
            elseif daletQuantity < 1 then
                ...
                if chanceToMiss <= Config.MissCraft then
                    ...
                    TriggerClientEvent('esx:showNotification', _source, _U('craft') .. _U('popsdinner') .. ' ~w~!')
                    xPlayer.removeInventoryItem('rhum', 2)
                    xPlayer.removeInventoryItem('limonade', 2)
                    xPlayer.removeInventoryItem('menthe', 2)
                    xPlayer.removeInventoryItem('ice', 1)
                    xPlayer.addInventoryItem('popsdinner', 1)
                end
            end
...
ESX.RegisterServerCallback('esx_popsdinnerjob:getVaultWeapons', function(source, cb)

  TriggerEvent('esx_datastore:getSharedDataStore', 'society_popsdinner', function(store)
...
ESX.RegisterServerCallback('esx_popsdinnerjob:addVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_popsdinnerjob:removeVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_popsdinnerjob:getPlayerInventory', function(source, cb)
