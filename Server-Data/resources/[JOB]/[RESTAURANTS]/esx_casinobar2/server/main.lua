...
RegisterServerEvent('esx_casinobar:startHarvest')
AddEventHandler('esx_casinobar:startHarvest', function(zone)
...
RegisterServerEvent('esx_casinobar:stopHarvest')
AddEventHandler('esx_casinobar:stopHarvest', function()
	local _source = source
	...
	if PlayersTransforming[source] == true then
		if zone == "Traitement" then
			...
			SetTimeout(Config.Zones.Traitement.TimerItem, function()
				if itemQuantity2 < Config.Zones.Traitement.MaxInventoryItem and itemQuantity > 24 then
...
RegisterServerEvent('esx_casinobar:startTransform')
AddEventHandler('esx_casinobar:startTransform', function(zone)
	local _source = source
...
RegisterServerEvent('esx_casinobar:stopTransform')
AddEventHandler('esx_casinobar:stopTransform', function()
...
RegisterServerEvent('esx_casinobar:startSell')
AddEventHandler('esx_casinobar:startSell', function(zone)
...
RegisterServerEvent('esx_casinobar:stopSell')
AddEventHandler('esx_casinobar:stopSell', function()
...
RegisterServerEvent('esx_casinobar:getStockItem')
AddEventHandler('esx_casinobar:getStockItem', function(itemName, count)
...
ESX.RegisterServerCallback('esx_casinobar:getStockItems', function(source, cb)
...
RegisterServerEvent('esx_casinobar:putStockItems')
AddEventHandler('esx_casinobar:putStockItems', function(itemName, count)
...
ESX.RegisterServerCallback('esx_casinobar:getPlayerInventory', function(source, cb)
