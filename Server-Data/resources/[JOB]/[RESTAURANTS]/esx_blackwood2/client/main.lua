...
function OpenGetStocksMenu()
	ESX.TriggerServerCallback('esx_blackwood:getStockItems', function(items)
		local elements = {}
		for i=1, #items, 1 do
				...
				ESX.UI.Menu.Open(
					...
					function(data2, menu2)
						...
						if count == nil or count <= 0 then
							...
							TriggerServerEvent('esx_blackwood:getStockItem', itemName, count)
						end
...
function OpenPutStocksMenu()
	...
	ESX.TriggerServerCallback('esx_blackwood:getPlayerInventory', function(inventory)
				...
				ESX.UI.Menu.Open(
					...
					function(data2, menu2)
						...
						if count == nil or count <= 0 then
							...
							TriggerServerEvent('esx_blackwood:putStockItems', itemName, count)
						end
...
AddEventHandler('esx_blackwood:hasEnteredMarker', function(zone)
...
AddEventHandler('esx_blackwood:hasExitedMarker', function(zone)
	ESX.UI.Menu.CloseAll()
	if (zone == 'Recolte') and PlayerData.job ~= nil and PlayerData.job.name == Config.NameJob then
		TriggerServerEvent('esx_blackwood:stopHarvest')
	end  
	if (zone == 'Traitement') and PlayerData.job ~= nil and PlayerData.job.name == Config.NameJob then
		TriggerServerEvent('esx_blackwood:stopTransform')
	end
	if (zone == 'Vente') and PlayerData.job ~= nil and PlayerData.job.name == Config.NameJob then
		TriggerServerEvent('esx_blackwood:stopSell')
	end
	CurrentAction = nil
end)
	...
	while true do
		...
		if PlayerData.job ~= nil and PlayerData.job.name == Config.NameJob then
			...
			if (isInMarker and not HasAlreadyEnteredMarker) or (isInMarker and LastZone ~= currentZone) then
				...
				TriggerEvent('esx_blackwood:hasEnteredMarker', currentZone)
			end

			if not isInMarker and HasAlreadyEnteredMarker then
				HasAlreadyEnteredMarker = false
				TriggerEvent('esx_blackwood:hasExitedMarker', LastZone)
			end
		end
	end
end)
		...
		if CurrentAction ~= nil then
			...
			if IsControlPressed(0,  Keys['E']) and PlayerData.job ~= nil and PlayerData.job.name == Config.NameJob and (GetGameTimer() - GUI.Time) > 300 then
				if CurrentAction == 'harvest' then
					TriggerServerEvent('esx_blackwood:startHarvest', CurrentActionData.zone)
				end
				if CurrentAction == 'traitement' then
					TriggerServerEvent('esx_blackwood:startTransform', CurrentActionData.zone)
				end
				...
				if CurrentAction == 'sell' then
					TriggerServerEvent('esx_blackwood:startSell', CurrentActionData.zone)
				end
