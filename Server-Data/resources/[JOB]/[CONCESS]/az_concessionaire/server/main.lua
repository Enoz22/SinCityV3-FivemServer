...
MySQL.ready(function()
	Categories     = MySQL.Sync.fetchAll('SELECT * FROM vehicle_categories_utilitaires')
	local vehicles = MySQL.Sync.fetchAll('SELECT * FROM vehicles_utilitaires')
...
AddEventHandler('esx_vehicleshop:getStockItem', function(itemName, count)
	...
	TriggerEvent('esx_addoninventory:getSharedInventory', 'cardealer', function(inventory)
