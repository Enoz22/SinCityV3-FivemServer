...
Config.Zones = {
	...
	ls1 = {
		Pos   = { x = -237.01, y = -1338.03, z = 29.9},
		Size  = {x = 18.0, y = 18.0, z = 0.2},
	...
	ls4 = {
		Pos   = { x = -212.87, y = -1320.66, z = 29.89},
		Size  = {x = 15.0, y = 15.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
		Hint  = _U('press_custom')
	...
	ls5 = {
		Pos   = { x = -198.65, y = -1324.54, z = -30.13},
		Size  = {x = 18.0, y = 18.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
