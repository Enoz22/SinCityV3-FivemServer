...
Config.Zones = {
  bennysActions = {
    Pos   = { x = -196.42, y = -1318.20, z = 30.20 },
  ...
  Craft = {
    Pos   = { x = -199.55, y = -1315.29, z = 30.20 },
		Size    = {x = 1.0, y = 1.0, z = 1.0},
		Color = {r = 17, g = 29, b = 210},
		Type    = 27, 
  },
  ...
  VehicleSpawnPoint = {
    Pos   = { x = -184.73, y = -1285.27, z = 30.3 },
    Size  = { x = 1.5, y = 1.5, z = 1.0 },
    Type  = -1,
  },

  VehicleDeleter = {
    Pos   = { x = -183.47, y = -1273.79, z = 30.3 },
