...
Citizen.CreateThread(function()
	while true do
		...
		if(PlayerData.job and PlayerData.job.name == "tattooaod") then
...
Citizen.CreateThread(function()
	while true do
		...
		if IsControlJustPressed(0, 167) and PlayerData.job and PlayerData.job.name == 'tattooaod' then
			OpenMobileActionsMenu()
		end

		if CurrentAction  and PlayerData.job and PlayerData.job.name == 'tattooaod' then
	...
	ESX.UI.Menu.Open(
	  ...
	  function(data, menu)
		...
		if data.current.value == 'boss_actions' then
		  TriggerEvent('esx_society:openBossMenu', 'tattooaod', function(data, menu)
			menu.close()
		  end)
		end
