...
function OpenAmmuCraftMenu()
  if Config.EnablePlayerManagement and PlayerData.job ~= nil and PlayerData.job.grade_name ~= 'recrue' and PlayerData.job.grade_name ~= 'employé' and PlayerData.job.name == 'ammunation' then
    ...
    --{label = 'Fusil de précision 2 - $ ' .. Config.Price.weapon_heavysniper, value = 'weapon_heavysniper'},
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if data.current.value == 'weapon_flashlight' then
		  ...
		  exports.utils:getUtils().showProgressBarTimer(15000, "Assemblage en cours ..", "Lampe assemblé !")
		  TaskStartScenarioInPlace(playerPed, "PROP_HUMAN_BUM_BIN", 15000, true)
		  Citizen.Wait(15000)
		  ClearPedTasksImmediately(playerPed)
        end
		...
		if data.current.value == 'weapon_switchblade' then
		  ...
		  exports.utils:getUtils().showProgressBarTimer(15000, "Assemblage en cours ..", "Cran d'arret assemblé !")
		  TaskStartScenarioInPlace(playerPed, "PROP_HUMAN_BUM_BIN", 15000, true)
		  Citizen.Wait(15000)
		  ClearPedTasksImmediately(playerPed)
        end
		...
		if data.current.value == 'weapon_bat' then
		  ...
		  exports.utils:getUtils().showProgressBarTimer(15000, "Assemblage en cours ..", "Batte assemblé !")
		  TaskStartScenarioInPlace(playerPed, "PROP_HUMAN_BUM_BIN", 15000, true)
		  Citizen.Wait(15000)
		  ClearPedTasksImmediately(playerPed)
        end
