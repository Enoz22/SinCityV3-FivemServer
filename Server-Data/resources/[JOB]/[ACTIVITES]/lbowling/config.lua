...
Strings = {
    ['press_start'] = 'Appuyez sur ~INPUT_PICKUP~ pour prendre une boule de bowling',
    ['next_last_select'] = '~INPUT_CELLPHONE_RIGHT~ ~INPUT_CELLPHONE_LEFT~ Parcourir\n~INPUT_FRONTEND_ENDSCREEN_ACCEPT~ Choisir\n~INPUT_FRONTEND_RRIGHT~ Annuler',
    ['bowling_info'] = '~INPUT_CELLPHONE_LEFT~ ~INPUT_CELLPHONE_RIGHT~ tourner\n~INPUT_CELLPHONE_UP~ ~INPUT_CELLPHONE_DOWN~ Change force\n~INPUT_MOVE_LEFT_ONLY~ ~INPUT_MOVE_RIGHT_ONLY~ parcourir les caméras\n~INPUT_ATTACK~ lancer\n~INPUT_FRONTEND_RRIGHT~ arrêter de jouer',
    ['force'] = 'Puissance: %s',
    ['strike'] = {'Félicitation, vous venez de faire un strike !!'},
    ['spare'] = {'Bowling', 'Bien joué! Vous avez fait un spare, continuez comme ça'},
    ['x_pinsdown'] = {'Bowling', 'Vous avez %s sur %s points'},
