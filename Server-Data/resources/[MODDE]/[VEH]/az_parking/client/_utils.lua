...
_Utils.GenerateVehicleLabel = function(vehicle)
	local vehiclename = _Utils.GetVehicleName(vehicle):upper()
...
_Utils.IncludeJob = function(authorizedJobs, job) 
	if authorizedJobs == nil or job == nil then return true end
