ESX.RegisterServerCallback('mg_realparking:getAllCars', function(source, cb)
...
RegisterServerEvent('mg_realparking:renamevehicle')
AddEventHandler('mg_realparking:renamevehicle', function(plate, name)
