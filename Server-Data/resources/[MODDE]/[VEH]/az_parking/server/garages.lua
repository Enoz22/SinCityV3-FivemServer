...
ESX.RegisterServerCallback("mg_realparking:getOutFromGarage", function(source, callback, vehicle, garageName)
...
ESX.RegisterServerCallback("mg_realparking:getCarGaragePrice", function(source, cb, plate)
...
ESX.RegisterServerCallback('mg_realparking:getGarageCars', function(source, cb, garageName)
    ...
    if _Garages[garageName] then
        ...
        _Utils.SendServerNotification(_U('garage_error'), 'error')
    end
end)

ESX.RegisterServerCallback('mg_realparking:storeVehicle', function(source, cb, vehicle)
    local _source = source
