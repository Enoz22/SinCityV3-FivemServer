Config = {
  ...
  LockpickFailChance        = 24,            -- % failure chance, if not using minigames for lockpicking.
  ...
  CreationJobs = {   
    immo = {                        -- JOB NAME.
      ...
      account = 'society_immo',     -- society account name
