...
furni.init = function()
  SendNUIMessage({
    type              = "init",
    onOpen            = "http://allhousing_furni/DoOpen",
    onClose           = "http://allhousing_furni/DoClose",
    onCancel          = "http://allhousing_furni/DoCancel",
    onSelect          = "http://allhousing_furni/DoSelect",
    onPlace           = "http://allhousing_furni/DoPlace",
    onStartAim        = "http://allhousing_furni/DoStartAim",
    onStopAim         = "http://allhousing_furni/DoStopAim",
    onReposition      = "http://allhousing_furni/DoReposition",
    onRepositionStart = "http://allhousing_furni/DoRepositionStart",
    onTransform       = "http://allhousing_furni/DoTransform",
    onEdit            = "http://allhousing_furni/DoEdit",
    onRemove          = "http://allhousing_furni/DoRemove",
    onExit            = "http://allhousing_furni/DoExit",
    items             = furni.objects,
    top               = "300px",
    left              = "20px",
  })
...
RegisterNUICallback('DoInit',             furni.awake)
