...
RegisterServerEvent('esx_aztecasjob:drag')
AddEventHandler('esx_aztecasjob:drag', function(target)
  local _source = source
  TriggerClientEvent('esx_aztecasjob:drag', target, _source)
end)
...
AddEventHandler('esx_aztecasjob:getStockItem', function(itemName, count)
...
AddEventHandler('esx_aztecasjob:putStockItems', function(itemName, count)
...
ESX.RegisterServerCallback('esx_aztecasjob:getFineList', function(source, cb, category)
  ...
  MySQL.Async.fetchAll(
    'SELECT * FROM fine_types_aztecas WHERE category = @category',
    {
      ['@category'] = category
    },
    function(fines)
