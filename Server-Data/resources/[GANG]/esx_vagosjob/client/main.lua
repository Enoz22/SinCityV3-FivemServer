...
AddEventHandler('esx_vagosjob:hasEnteredEntityZone', function(entity)

  local playerPed = GetPlayerPed(-1)

  if (PlayerData.job ~= nil and PlayerData.job.name == 'vagos') or (PlayerData.job2 ~= nil and PlayerData.job2.name == 'vagos') or (PlayerData.job3 ~= nil and PlayerData.job3.name == 'vagos') and not IsPedInAnyVehicle(playerPed, false) then
...
AddEventHandler('esx_vagosjob:hasExitedEntityZone', function(entity)
...
Citizen.CreateThread(function()
  while true do
    ...
    if (PlayerData.job ~= nil and PlayerData.job.name == 'vagos') or (PlayerData.job2 ~= nil and PlayerData.job2.name == 'vagos') or (PlayerData.job3 ~= nil and PlayerData.job3.name == 'vagos') then
      ...
      for k,v in pairs(Config.VagosStations) do
		...
		if Config.EnablePlayerManagement and PlayerData.job2 ~= nil and PlayerData.job2.name == 'vagos' and PlayerData.job2.grade_name == 'boss' then
		...
		if Config.EnablePlayerManagement and PlayerData.job3 ~= nil and PlayerData.job3.name == 'vagos' and PlayerData.job3.grade_name == 'boss' then
  ...
  while true do
    ...
    if closestDistance ~= -1 and closestDistance <= 3.0 then
      ...
      if LastEntity ~= closestEntity then
        TriggerEvent('esx_vagosjob:hasEnteredEntityZone', closestEntity)
      ...
      if LastEntity ~= nil then
        TriggerEvent('esx_vagosjob:hasExitedEntityZone', LastEntity)
        LastEntity = nil
      end
...
Citizen.CreateThread(function()
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlPressed(0,  Keys['E']) and PlayerData.job ~= nil and PlayerData.job.name == 'vagos' and (GetGameTimer() - GUI.Time) > 150 then
   ...
   if IsControlPressed(0,  Keys['F6']) and PlayerData.job ~= nil and PlayerData.job.name == 'vagos' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'vagos_actions') and (GetGameTimer() - GUI.Time) > 150 then
...
Citizen.CreateThread(function()
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlPressed(0,  Keys['E']) and PlayerData.job2 ~= nil and PlayerData.job2.name == 'vagos' and (GetGameTimer() - GUI.Time) > 150 then
   ...
   if IsControlPressed(0,  Keys['F9']) and PlayerData.job2 ~= nil and PlayerData.job2.name == 'vagos' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'vagos_actions') and (GetGameTimer() - GUI.Time) > 150 then
     OpenVagosActionsMenu()
     GUI.Time = GetGameTimer()
    end
...
Citizen.CreateThread(function()
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlPressed(0,  Keys['E']) and PlayerData.job3 ~= nil and PlayerData.job3.name == 'vagos' and (GetGameTimer() - GUI.Time) > 150 then
   ...
   if IsControlPressed(0,  Keys['F9']) and PlayerData.job3 ~= nil and PlayerData.job3.name == 'vagos' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'vagos_actions') and (GetGameTimer() - GUI.Time) > 150 then
     OpenVagosActionsMenu()
     GUI.Time = GetGameTimer()
    end
...
RegisterNetEvent('NB:openMenuVagos')
AddEventHandler('NB:openMenuVagos', function()
	OpenVagosActionsMenu()
end)