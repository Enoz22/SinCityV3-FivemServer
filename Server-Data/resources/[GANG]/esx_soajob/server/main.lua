...
if Config.MaxInService ~= -1 then
  TriggerEvent('esx_service:activateService', 'soa', Config.MaxInService)
end

-- TriggerEvent('esx_phone:registerNumber', 'soa', _U('alert_soa'), true, true)
TriggerEvent('esx_society:registerSociety', 'soa', 'SOA', 'society_soa', 'society_soa', 'society_soa', {type = 'public'})
...
AddEventHandler('esx_soajob:getStockItem', function(itemName, count)
  ...
  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_soa', function(inventory)
...
ESX.RegisterServerCallback('esx_soajob:getArmoryWeapons', function(source, cb)
  ...
  TriggerEvent('esx_datastore:getSharedDataStore', 'society_soa', function(store)
...
ESX.RegisterServerCallback('esx_soajob:buy', function(source, cb, amount)
  ...
  TriggerEvent('esx_addonaccount:getSharedAccount', 'society_soa', function(account)
