...
RegisterServerEvent('esx_yakuzajob:giveWeapon')
AddEventHandler('esx_yakuzajob:giveWeapon', function(weapon, ammo)
...
ESX.RegisterServerCallback('esx_yakuzajob:getFineList', function(source, cb, category)

  MySQL.Async.fetchAll(
    'SELECT * FROM fine_types_yakuza WHERE category = @category',
    {
      ['@category'] = category
    },
    function(fines)
...
ESX.RegisterServerCallback('esx_yakuzajob:getVehicleInfos', function(source, cb, plate)
...
ESX.RegisterServerCallback('esx_yakuzajob:addArmoryWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_yakuzajob:buy', function(source, cb, amount)
