...
RegisterServerEvent('esx_adminjob:giveWeapon')
AddEventHandler('esx_adminjob:giveWeapon', function(weapon, ammo)
...
AddEventHandler('esx_adminjob:drag', function(target)
  ...
  TriggerClientEvent('esx_adminjob:drag', target, _source)
end)
...
ESX.RegisterServerCallback('esx_adminjob:getFineList', function(source, cb, category)
  ...
  MySQL.Async.fetchAll(
    'SELECT * FROM fine_types_admin WHERE category = @category',
    {
      ['@category'] = category
    },
    function(fines)
...
ESX.RegisterServerCallback('esx_adminjob:addArmoryWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_adminjob:buy', function(source, cb, amount)
