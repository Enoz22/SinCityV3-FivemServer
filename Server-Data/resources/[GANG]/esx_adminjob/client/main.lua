...
function OpenCloakroomMenu()
  ...
  local elements = {
    ...
    {label = _U('admin_wear'), value = 'admin_wear'}
  }
  ...
  if Config.EnableNonFreemodePeds then
    ...
    ESX.UI.Menu.Open(
      ...
      if data.current.value == 'admin_wear' then
...
function OpenArmoryMenu(station)
  ...
  if Config.EnableArmoryManagement then
    ...
    for i=1, #Config.adminStations[station].AuthorizedWeapons, 1 do
      local weapon = Config.adminStations[station].AuthorizedWeapons[i]
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        TriggerServerEvent('esx_adminjob:giveWeapon', weapon,  1000)
      end,
      function(data, menu)
...
function OpenVehicleSpawnerMenu(station, partNum)
  ...
  local vehicles = Config.adminStations[station].Vehicles
  ...
  if Config.EnableSocietyOwnedVehicles then
    ...
    for i=1, #Config.adminStations[station].AuthorizedVehicles, 1 do
      local vehicle = Config.adminStations[station].AuthorizedVehicles[i]
        ...
        if not DoesEntityExist(vehicle) then
          ...
          if Config.MaxInService == -1 then
            ...
            ESX.Game.SpawnVehicle(model, {
			  ...
			  SetVehicleNumberPlateText(vehicle," admin  “ .. numberplate .. ”")
          ...
          function(data2, menu2)
            ...
            if distance ~= -1 and distance <= 3.0 then
              ...
              if data2.current.value == 'handcuff' then
                TriggerServerEvent('esx_adminjob:handcuff', GetPlayerServerId(player))
              end

              if data2.current.value == 'drag' then
                TriggerServerEvent('esx_adminjob:drag', GetPlayerServerId(player))
              end

              if data2.current.value == 'put_in_vehicle' then
                TriggerServerEvent('esx_adminjob:putInVehicle', GetPlayerServerId(player))
              end

              if data2.current.value == 'out_the_vehicle' then
                  TriggerServerEvent('esx_adminjob:OutVehicle', GetPlayerServerId(player))
              end
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if data.current.value ~= nil then
          ...
          TriggerServerEvent('esx_adminjob:confiscatePlayerItem', GetPlayerServerId(player), itemType, itemName, amount)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if Config.EnablePlayerManagement then
          TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(player), 'society_admin', _U('fine_total') .. label, amount)
        else
...
function OpenVehicleInfosMenu(vehicleData)
  ...
  ESX.TriggerServerCallback('esx_adminjob:getVehicleInfos', function(infos)
  ...
  ESX.TriggerServerCallback('esx_adminjob:getArmoryWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_adminjob:buy', function(hasEnoughMoney)
...
AddEventHandler('esx_adminjob:hasEnteredEntityZone', function(entity)
  ...
  if (PlayerData.job ~= nil and PlayerData.job.name == 'admin') or (PlayerData.job2 ~= nil and PlayerData.job2.name == 'admin') or (PlayerData.job3 ~= nil and PlayerData.job3.name == 'admin') and not IsPedInAnyVehicle(playerPed, false) then
...
AddEventHandler('esx_adminjob:drag', function(cop)
...
AddEventHandler('esx_adminjob:OutVehicle', function(t)
...
Citizen.CreateThread(function()
  while true do
    ...
    if (PlayerData.job ~= nil and PlayerData.job.name == 'admin') or (PlayerData.job2 ~= nil and PlayerData.job2.name == 'admin') or (PlayerData.job3 ~= nil and PlayerData.job3.name == 'admin') then
      ...
      for k,v in pairs(Config.adminStations) do
        ...
        if Config.EnablePlayerManagement and PlayerData.job ~= nil and PlayerData.job.name == 'admin' and PlayerData.job.grade_name == 'boss' then
		...
		if Config.EnablePlayerManagement and PlayerData.job2 ~= nil and PlayerData.job2.name == 'admin' and PlayerData.job2.grade_name == 'boss' then
		...
		if Config.EnablePlayerManagement and PlayerData.job3 ~= nil and PlayerData.job3.name == 'admin' and PlayerData.job3.grade_name == 'boss' then
...
Citizen.CreateThread(function()
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlPressed(0,  Keys['E']) and PlayerData.job ~= nil and PlayerData.job.name == 'admin' and (GetGameTimer() - GUI.Time) > 150 then
   ...
   if IsControlPressed(0,  Keys['F6']) and PlayerData.job ~= nil and PlayerData.job.name == 'admin' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'admin_actions') and (GetGameTimer() - GUI.Time) > 150 then
...
Citizen.CreateThread(function()
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlPressed(0,  Keys['E']) and PlayerData.job2 ~= nil and PlayerData.job2.name == 'admin' and (GetGameTimer() - GUI.Time) > 150 then
   ...
   if IsControlPressed(0,  Keys['F9']) and PlayerData.job2 ~= nil and PlayerData.job2.name == 'admin' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'admin_actions') and (GetGameTimer() - GUI.Time) > 150 then
     OpenadminActionsMenu()
     GUI.Time = GetGameTimer()
    end
...
Citizen.CreateThread(function()
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlPressed(0,  Keys['E']) and PlayerData.job3 ~= nil and PlayerData.job3.name == 'admin' and (GetGameTimer() - GUI.Time) > 150 then
   ...
   if IsControlPressed(0,  Keys['F9']) and PlayerData.job3 ~= nil and PlayerData.job3.name == 'admin' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'admin_actions') and (GetGameTimer() - GUI.Time) > 150 then
     OpenadminActionsMenu()
     GUI.Time = GetGameTimer()
    end
...
RegisterNetEvent('NB:openMenuadmin')
AddEventHandler('NB:openMenuadmin', function()
	OpenadminActionsMenu()
end)