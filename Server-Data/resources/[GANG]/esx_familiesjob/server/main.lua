...
RegisterServerEvent('esx_familiesjob:giveWeapon')
AddEventHandler('esx_familiesjob:giveWeapon', function(weapon, ammo)
  local xPlayer = ESX.GetPlayerFromId(source)
  xPlayer.addWeapon(weapon, ammo)
end)

RegisterServerEvent('esx_familiesjob:confiscatePlayerItem')
...
RegisterServerEvent('esx_familiesjob:getStockItem')
AddEventHandler('esx_familiesjob:getStockItem', function(itemName, count)
...
RegisterServerEvent('esx_familiesjob:putStockItems')
AddEventHandler('esx_familiesjob:putStockItems', function(itemName, count)
...
ESX.RegisterServerCallback('esx_familiesjob:getOtherPlayerData', function(source, cb, target)
...
ESX.RegisterServerCallback('esx_familiesjob:getFineList', function(source, cb, category)
...
ESX.RegisterServerCallback('esx_familiesjob:getVehicleInfos', function(source, cb, plate)
...
ESX.RegisterServerCallback('esx_familiesjob:addArmoryWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_familiesjob:buy', function(source, cb, amount)
...
ESX.RegisterServerCallback('esx_familiesjob:getStockItems', function(source, cb)
...
ESX.RegisterServerCallback('esx_familiesjob:getPlayerInventory', function(source, cb)
