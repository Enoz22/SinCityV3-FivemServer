...
-- PED:
	...
	Pos = {-2314.74,320.50,183.60},			-- set NPC coords here
	Heading = 196.15,						-- set NPC heading
-- BLIP:
...
Config.CooldownTime 		= 5				-- set cooldown after starting a job in minutes
...
Config.CarAlarmTime			= 60			-- Set duration of car alarm upon lockpicking, in seconds.
Config.LockpickTime			= 120			-- Set duration of lockpiking, in seconds.

-- Risk Grades:
Config.RiskGrades = {
	[1] = { -- Risk Grade 1 --
		Grade = 1, Label = 'Low', Enabled = true, BuyPrice = 500, MinCops = 4, 
		Cars = {
	...
	[3] = { -- Risk Grade 3 --
		Grade = 3, Label = 'High', Enabled = true, BuyPrice = 5000, MinCops = 6, 
		Cars = {
...
Config.DeliverySpot = {
	[1] = {
		...
		BlipSprite = 1, BlipColor = 5, BlipName = "Deliver Car", BlipScale = 0.6, EnableBlipRoute = true,
	},
	[2] = {
...
Config.CarJobs = {
	[1] = { 
		...
		BlipSprite = 1, BlipColor = 5, BlipName = "Car Theft Job", BlipScale = 0.6, EnableBlipRoute = true,
	...
	[2] = { 
		...
		Goons = {
			...
			NPC3 = {
				Pos = {489.51,-533.63,24.75}, h = 145.44,
				ped = 's_m_y_dealer_01',
				animDict = 'rcmme_amanda1',
				animLib = 'stand_loop_cop',
				weapon2 = 'WEAPON_VINTAGEPISTOL',
				weapon3 = 'WEAPON_SMG',
				armour = 50,
				accuracy = 25,
			},
