...
local cropstateMethods = {
    plant = function(instance, location, soil, stage, source)
        if onServer then
            ...
            Citizen.Trace("Attempt to cropstateOpium:plant on client. Not going to work.\n")
        end
    end,
    load = function(instance, callback)
        if onServer then
            ...
            Citizen.Trace("Attempt to cropstateOpium:load on client. Not going to work\n")
        end
    end,
...
setmetatable(cropstateOpium,cropstateMeta)
