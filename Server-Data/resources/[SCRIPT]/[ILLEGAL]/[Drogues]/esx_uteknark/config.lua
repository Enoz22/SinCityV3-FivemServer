Config = {
    Nbr = 30,     -- Nombre de plant par personne
    debug = true,
    Locale = 'en-US',
    ProtectionHour = false,
    ...
    ScenarioTime = 4000,  -- How long should the scenario/animations run?
    MaxGroundAngle = 0.6, -- How tilted can the ground be and still hold plants?
    Items = { -- What items are used?
        Seed = 'ingreweed',     -- Used to plant the weed
        Tend = 'purifiedwater',             -- Optional item to progress growth cycle
        Waterplus = 'purifiedwater',             -- Optional item water
        water = 'wateringcan',             -- Optional item water
    ...
    Burn = { -- Burn effect when destroying a plant
        ...
        Duration    = 10000,                        -- How long should it burn, in milliseconds?
    },
...
Uteknarkplantation = {
        {
            coord = vector3(259.85, 6464.03, 31.17), -- Champ de WEED Paleto
            dist = 50,
        },
		{
            coord = vector3(2035.31 ,4908.75,41.70), -- Champ de WEED2 Monts se san chianski
            dist = 50,
        },
    }
