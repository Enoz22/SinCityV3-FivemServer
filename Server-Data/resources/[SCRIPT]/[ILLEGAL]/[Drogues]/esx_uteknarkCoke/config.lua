Config = {
    ...
    Items = { -- What items are used?
        Seed = 'grainecoka',     -- Used to plant the weed
        Tend = 'purifiedwater',             -- Optional item to progress growth cycle
        Product = 'feuillecoca', -- What item is given when you harvest?
    },
    Scenario = {
    ...
    Yield = {5,8}, -- How many Items.Product does each plant yield? {5,10} means "from 5 to 10, inclusive"
...
Uteknarkplantation = {
    {
        coord = vector3(658.44,6479.56,30.44), -- Champ Weed Paleto
        dist = 70,
    },
    {
        coord = vector3(2528.92,4362.6,39.8), -- Champ Grapeseed
        dist = 40,
    },
}