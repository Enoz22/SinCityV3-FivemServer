...
local cropstateMethods = {
    plant = function(instance, location, soil, stage, source)
        if onServer then
            ...
            Citizen.Trace("Attempt to cropstateCoke:plant on client. Not going to work.\n")
        end
    end,
    load = function(instance, callback)
        if onServer then
            ...
            Citizen.Trace("Attempt to cropstateCoke:load on client. Not going to work\n")
        end
    end,
...
setmetatable(cropstateCoke,cropstateMeta)
