...
Config.RiskGrades = {
	...
	[3] = { -- Risk Grade 3 --
		...
		Cars = {
			[1] = { Name = "zentorno", Hash = -1297672541, Reward = 8350 },
			[2] = { Name = "F620", Hash = 2072687711, Reward = 7950 },
			[3] = { Name = "Tailgater", Hash = -142942670, Reward = 7350 },
			-- add more cars here
		}, 
	},
}
	...
	[1] = { 
		...
		Goons = {
			NPC1 = {
				...
				weapon2 = 'WEAPON_APPISTOL',										-- NPC Weapon when choosing risk grade 2 job
				weapon3 = 'WEAPON_PISTOL',									-- NPC Weapon when choosing risk grade 3 job
				armour = 0,												-- NPC Body Armour value
