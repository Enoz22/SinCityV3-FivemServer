...
--IMPORTANT STUFF--
Config.Language = 'fr' --Default language, make your own language under the languages section.
Config.UsingESX = true --Set this to true if you are using ESX.
...
Config.Shops = {
    [1] = {
        ...
        registerBlack_Money = {2000, 3000}, --The money you can get from the register, from low to high.
        safeCoords = vector3(-43.92, -1748.08, 29.42),
        safeMoney = {500, 1000}, --The money you can get from the safe, from low to high.
        ...
        camera = {4,1,2}, --Example: {1,2,3} for multiple cameras.
