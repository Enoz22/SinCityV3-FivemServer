...
-- Police Settings:
Config.PoliceJobs = {"police", "bsco"}	-- Jobs that can't do bankrobberies etc, but can secure the banks.
...
Config.Banks = {
    [1] = {
        ...
        blip = {enable = true, bName = "Fleeca Bank", display = 4, sprite = 431, color = 5, scale = 0.7},
