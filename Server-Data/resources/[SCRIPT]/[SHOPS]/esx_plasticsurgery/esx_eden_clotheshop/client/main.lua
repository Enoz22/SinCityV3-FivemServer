				...
				if data.current.value == 'yes' then
					...
					ESX.TriggerServerCallback('esx_eden_clotheshop:checkMoney', function(hasEnoughMoney)
						...
						if hasEnoughMoney then
								...
								if foundStore then
									...
									ESX.UI.Menu.Open(
										'default', GetCurrentResourceName(), 'save_dressing',
										{
											...
											align = 'right',
											elements = {
												{label = ('<span style="color:lightgreen;">Sauvegarder dans la garde robe</span>'), value = 'yes'},
												{label = ('<span style="color:red;">Annuler</span>'),  value = 'no'},
											}
										},
											...
											if data2.current.value == 'yes' then
												...
												ESX.UI.Menu.Open(
													...
													function(data3, menu3)
														...
														--ESX.ShowAdvancedColoredNotification(('Magasin'), ('de vetements'), _U('saved_outfit'), 'CHAR_HUMANDEFAULT', 1, 2)
							...
							ESX.ShowAdvancedColoredNotification(('Magasin'), ('de vetements'), _U('not_enough_money'), 'CHAR_BANK_MAZE', 1, 2)
            ...
            function(data, menu)
              ...
              TriggerEvent('skinchanger:getSkin', function(skin)
                ...
                ESX.TriggerServerCallback('esx_eden_clotheshop:getPlayerOutfit', function(clothes)
				  ...
				  --ESX.ShowAdvancedColoredNotification(('Magasin'), ('de vetements'), _U('loaded_outfit'), 'CHAR_HUMANDEFAULT', 1, 2)
				  HasLoadCloth = true
	  ...
	  if data.current.value == 'suppr_cloth' then
		ESX.TriggerServerCallback('esx_eden_clotheshop:getPlayerDressing', function(dressing)
			...
			menu.close()
				...
				ESX.ShowAdvancedColoredNotification(('Magasin'), ('de vetements'), _U('supprimed_cloth'), 'CHAR_HUMANDEFAULT', 1, 2)
...
Citizen.CreateThread(function()
	...
	for i=1, #Config.Shops, 1 do
		...
		AddTextComponentString("Magasin de Vetements")
