...
function CreateScale(sType)
	if scaleString ~= sType and sType == "OpenShop" then
		scaleType = setupScaleform("instructional_buttons", "Regarder le catalogue des tatouages", 38)
		scaleString = sType
	elseif scaleString ~= sType and sType == "Control" then
		scaleType = setupScaleform2("instructional_buttons", "Changer la vue de la caméra", 21, "Changer l'opacité", {90, 89}, "Acheter/Supprimer le tatouage", 191)
		scaleString = sType
	end
end
