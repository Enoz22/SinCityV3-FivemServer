Config = {
    ...
    Items = {
        ["drinks"] = {
            {label = "Soda", item = "soda", price = 20},
            {label = "Fanta Exotic", item = "fanta", price = 20},
        },
        ["snacks"] = {
            {label = "Sim", item = "sim", price = 30},
            {label = "Téléphone", item = "phone", price = 27},
            {label = "Radio", item = "radio", price = 18},
        },
        ["readymeal"] = {
            {label = "Sandwich", item = "sandwich", price = 20},
            {label = "chips", item = "chips", price = 20},
        },
        ["diverse"] = {
            {label = "Bouteille de gaz", item = "gazbottle", price = 10},
            {label = "Scaphandre", item = "scuba", price = 20},
            {label = "Briquet", item = "lighter", price = 5},
            {label = "Canne à pêche", item = "fishingrod", price = 20},
            {label = "Appât à poissons", item = "fishbait", price = 20},
        },
    },
}