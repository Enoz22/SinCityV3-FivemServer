...
$(document).on('click', "#initiateDeposit", function(e) {
    ...
    if (amount !== undefined && amount > 0) {
        ...
        $("#depositErrorMsg").html("Veuillez saisir un montant valide pour le dépôt");
    }
})
...
$(document).on('click', "#initiateWithdraw", function(e) {
    ...
    if (amount !== undefined && amount > 0) {
        ...
        $("#withdrawErrorMsg").html("Veuillez saisir un montant valide pour le retrait");
    }
})
...
$(document).on('click', "#initiateWithdrawATM", function(e) {
    ...
    if (amount > 5000) {
        ...
        $("#withdrawErrorMsgATM").html("Vous êtes limités à 5000 $ de retrait maximum.");
        return
    }
    if (amount !== undefined && amount > 0) {
        ...
        $("#withdrawErrorATM").css({"display":"block"});
        $("#withdrawErrorMsgATM").html("Veuillez saisir un montant valide pour le retrait");
    }
})
