...
voip['local'] = {name = 'normal', setting = 18.0}
voip['whisper'] = {name = 'chuchoter', setting = 4.0}
voip['yell'] = {name = 'crier', setting = 35.0}
...
AddEventHandler('pv:voip', function(voipDistance)
	...
	NotificationMessage("Votre voix est maintenant ~b~" .. voipsetting ..".")
