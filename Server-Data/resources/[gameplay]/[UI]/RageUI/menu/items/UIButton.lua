    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() then
            ...
            if CurrentMenu.Pagination.Minimum <= Option and CurrentMenu.Pagination.Maximum >= Option then
                ...
                local haveLeftBadge = (Style.LeftBadge and Style.LeftBadge ~= RageUI.BadgeStyle.None or tonumber(Style.LeftBadge) ~= nil)
                local haveRightBadge = (Style.RightBadge and Style.RightBadge ~= RageUI.BadgeStyle.None or tonumber(Style.RightBadge) ~= nil)
