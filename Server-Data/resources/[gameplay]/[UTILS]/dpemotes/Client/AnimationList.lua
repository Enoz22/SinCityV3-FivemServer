...
DP.Emotes = {
    ...
    ["waithight1"] = {"anim@miss@low@fin@vagos@", "idle_ped06", "Bras dans le dos fixe", AnimationOptions = 
    { 
        EmoteLoop = true, 
    }}, 
    
    ["waithight2"] = {"anim@miss@low@fin@vagos@", "idle_ped06", "Bras dans le dos marche", AnimationOptions = 
    { 
        EmoteLoop = true, 
        EmoteMoving = true, 
    }},
