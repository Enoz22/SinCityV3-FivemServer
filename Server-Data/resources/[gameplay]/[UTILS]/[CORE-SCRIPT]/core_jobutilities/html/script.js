...
$(document).keyup(function(e) {
    if (e.keyCode === 27) {
        ...
        $.post('https://core_jobutilities/close', JSON.stringify({}));
...
'        <p id="inputtext">ENTRER LE BONUS</p>'+
...
'        <p id="inputtext">Êtes-vous sûr ?</p>'+
'        <p id="inputothertext">Voulez-vous virer ' +$(t).parent().find("#u746").text()+'</p>'+
...
function hireperson(t) {
    ...
    playClickSound();
        ...
        $("#main_container").fadeOut("slow", function() {
          ...
          $.post('https://core_jobutilities/hire', JSON.stringify({job: currentBossMenuJob, id: id}));
}
...
function withdrawAmount(t) {
    ...
    playClickSound();
        ...
        $("#main_container").fadeOut("slow", function() {
          ...
          $.post('https://core_jobutilities/withdraw', JSON.stringify({job: currentBossMenuJob, amount: amount}));
}
...
function givebonus(t) {
    ...
    playClickSound();
        ...
        $("#main_container").fadeOut("slow", function() {
          ...
          $.post('https://core_jobutilities/givebonus', JSON.stringify({identifier: identifier, amount: amount, job: currentBossMenuJob}));
}
...
function depositAmount(t) {
    ...
    playClickSound();
        ...
        $("#main_container").fadeOut("slow", function() {
          ...
          $.post('https://core_jobutilities/deposit', JSON.stringify({job: currentBossMenuJob, amount: amount}));
}
...
function fire(t) {
    ...
    playClickSound();
        ...
        $("#main_container").fadeOut("slow", function() {
          ...
          $.post('https://core_jobutilities/fire', JSON.stringify({identifier: identifier, job: currentBossMenuJob}));
...
function promote(t) {
    ...
    playClickSound();
        ...
        $("#main_container").fadeOut("slow", function() {
          ...
          $.post('https://core_jobutilities/setrank', JSON.stringify({identifier: identifier, rank: rank, job: currentBossMenuJob}));
...
window.addEventListener('message', function(event) {
    ...
    $(".addjob").click(function() {
        ...
        if ($(this).text().replace(/ /g, '') != 'PRIS') {
            $(document).find(".addjob").text('CHOISIR');
            $(this).text('PRIS');
            $.post('https://core_jobutilities/addjob', JSON.stringify({
