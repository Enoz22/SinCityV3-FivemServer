...
UsingCoreEvidence = true, -- If you are using Core Evidence (https://core.tebex.io/package/4265655) it adds (undetectable bullet shells)

SetVestIfNone = true, -- Sets a vest to a player when armor used
VestId = 10, -- The id of the vest set
