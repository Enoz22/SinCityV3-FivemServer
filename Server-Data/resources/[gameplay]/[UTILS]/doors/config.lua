...
AuthorizedItems = {
  ...
  pd_card    = "Carte d'accées agent du LSPD",
  pd_card_visitor    = "Carte d'accées Visiteur LSPD",
...
Labels = {
  unlock            = "Ouvrir",
  lock              = "Fermer",
  do_unlock         = "[~r~Déverrouiller~s~] ",
  do_lock           = "[~g~Vérrouiller~s~] ",
  access_granted    = "~g~Accès Autorisé.~s~",
  access_denied     = "~r~Accès Refusé.~s~",
  key_shop_3dtxt    = "[~g~E~s~] Boutique de clés",
  key_shop_helptxt  = "~INPUT_PICKUP~ Aide boutique de clés",
  key_shop_bliptxt  = "Stockage de clé",
  no_bank_acc       = "Impossible de trouver le compte bancaire.",
  police_warning    = "Quelqu'un tente de pénétrer dans une porte à %s. \nPress ~INPUT_PICKUP~ pour régler le GPS."
}
