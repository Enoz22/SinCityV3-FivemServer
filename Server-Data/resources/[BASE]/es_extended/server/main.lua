Citizen.CreateThread(function()
	SetMapName('Los Santos - Sincity Life')
...
function onPlayerJoined(playerId)
	...
	if identifier then
		if ESX.GetPlayerFromIdentifier(identifier) then
			...
			MySQL.Async.fetchScalar('SELECT accounts,identifier FROM users WHERE identifier = @identifier', {
...
AddEventHandler('playerDropped', function(reason)
	...
	if xPlayer then
		...
		print("player Dropped es_extended server->main.lua")
...
RegisterNetEvent('esx:removeInventoryItem') -- Drop item
...
RegisterNetEvent('esx:onPickup') -- Drop item
