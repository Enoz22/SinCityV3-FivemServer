--[[ Server Side ]]
RS.weapons_serverSide = true -- Enable/Disable Server Side Weapons Detection

RS.weapons_serverSide_Give = true -- Detects ANY weapon Give [[This is not going to detect self-giving]]
RS.weapons_serverSide_GiveBlacklisted = true -- Detects Blacklisted ONLY weapon Give [[This is not going to detect self-giving]]
RS.weapons_serverSide_GiveAmmo = true
    RS.weapons_serverSide_GiveAmmo_maxAmount = 250 -- Max amount of ammo that a player can give [[This is not going to detect self-giving]]
...
--[[ Client Side ]]
RC.weapons_clientSide = true -- Perform Weapons check on unauthorized players (not chocohax.weapons)
RS.weapons_clientSide_DetectionMode = 2 -- 0 Warning, 1 Kick, 2 Ban

-- Projectile Detection
RS.weapons_useProjectileControl = true -- Enable/Disable Projectile Detection
RS.weapons_Projectile_BlockAll = true -- TRUE = Block and Detect any projectile / FALSE = Block and Detect ONLY blacklisted ones (Blacklisted weapons)
RS.weapons_Projectile_DetectionMode = 2 -- 0 Warning, 1 Kick, 2 Ban

RS.weapons_BlacklistedTable = { -- Remember to use `--` to comment the line of the weapon you want to unblacklist
    -- Melee
