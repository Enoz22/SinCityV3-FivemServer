...
local admins = {
    ...
    'license:6264c228b6a562daddfd1ec2d2c6f73427d1cc82',
}
-- resourceName = "vSync"
-- AddEventHandler('onResourceStart', function(resourceName)

--     MySQL.Async.fetchAll('SELECT identifier FROM users WHERE group = admin', {
-- 	}, function(result)
--         print(result)
...
function NextWeatherStage()
    if CurrentWeather == "CLEAR" or CurrentWeather == "CLOUDS" or CurrentWeather == "EXTRASUNNY"  then
        ...
        print('NOUVEAU RAND' .. CurrentWeather .. '|' .. new)
        if new == 1 then
